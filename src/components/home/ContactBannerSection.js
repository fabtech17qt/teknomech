  ...
  async function handleSubmit(e) {
    ...
    try {
      await fetch('/api/contact', {
        ...
        body: JSON.stringify({ ...form, email: 'quick-form@teknomech.qa', company: '' }),
      });
    } catch {}
    setLoading(false);
    setSent(true);
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row min-h-[480px] pt-14">
        ...
        <div className="relative flex-1 lg:w-3/5 bg-brand-blue-deep overflow-hidden lg:rounded-tr-[80px] lg:rounded-br-[80px]">
          ...
          <AnimateIn variant="fadeRight" className="px-10 md:px-16 py-20 relative z-10 h-full flex flex-col justify-center">
        ...
        {/* ── RIGHT : orange form ── */}
        <div className="relative lg:w-2/5 bg-brand-orange overflow-hidden">
          {/* Stripe pattern */}
          <div
          ...
          <AnimateIn variant="fadeLeft" className="px-10 py-20 relative z-10 h-full flex flex-col justify-center">
